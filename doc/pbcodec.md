...
```
    go get -v github.com/songweihang/cellnet/protoc-gen-msg

    go install -v github.com/songweihang/cellnet/protoc-gen-msg
```
...
```
${GOPATH}/github.com/songweihang/cellnet/codec/gogopb/test/export.sh
```
